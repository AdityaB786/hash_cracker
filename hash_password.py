...
print(r'''_  _ ____ ____ _  _    ___  _  _ ____ ___ ____ ____
...
def grepper(directory):
    os.system(r'''grep -Pr "[a-f0-9]{128}|[a-f0-9]{96}|[a-f0-9]{64}|[a-f0-9]{40}|[a-f0-9]{32}" %s --exclude=\*.{png,jpg,jpeg,mp3,mp4,zip,gz} |
